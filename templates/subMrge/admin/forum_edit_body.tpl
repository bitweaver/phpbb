...
<form action="{S_FORUM_ACTION}" method="post">
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<tr> 
	  <td class="odd">{L_FORUM_NAME}</td>
	  <td class="even"><input type="text" size="25" name="forumname" value="{FORUM_NAME}" class="post" /></td>
	</tr>
	<tr> 
	  <td class="odd">{L_FORUM_DESCRIPTION}</td>
	  <td class="even"><textarea rows="5" cols="45" wrap="virtual" name="forumdesc" class="post">{DESCRIPTION}</textarea></td>
	</tr>
	<tr> 
	  <td class="odd">{L_CATEGORY}</td>
	  <td class="even"><select name="c">{S_CAT_LIST}</select></td>
	</tr>
	<tr> 
	  <td class="odd">{L_FORUM_STATUS}</td>
	  <td class="even"><select name="forumstatus">{S_STATUS_LIST}</select></td>
	</tr>
	<tr> 
	  <td class="odd">{L_AUTO_PRUNE}</td>
