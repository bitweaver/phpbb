...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_SIGNATURE}</span><br />
		<small>{L_SIGNATURE_EXPLAIN}<br />
		<br />
		{HTML_STATUS}<br />
		{BBCODE_STATUS}<br />
	...
	<tr> 
	  <td class="catsides" colspan="2"><h2>&nbsp;</h2></td>
	</tr>
	<tr> 
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_NOTIFY_ON_REPLY}</span></td>
	  <td class="even"> 
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_POPUP_ON_PRIVMSG}</span></td>
	  <td class="even"> 
	...
	<tr> 
	  ...
	  <td class="even">{LANGUAGE_SELECT}</td>
	</tr>
	<tr> 
	  ...
	  <td class="odd" colspan="2"> 
		<table width="70%" cellspacing="2" cellpadding="0" border="0">
		  <tr> 
			...
			<td align="center"><small>{L_CURRENT_IMAGE}</span><br />
			  {AVATAR}<br />
			  <input type="checkbox" name="avatardel" />
			  &nbsp;<small>{L_DELETE_AVATAR}</span></td>
		  </tr>
		</table>
	  </td>
	</tr>
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_UPLOAD_AVATAR_URL}</span></td>
	  <td class="even"> 
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_LINK_REMOTE_AVATAR}</span></td>
	  <td class="even"> 
	...
	<tr>
	  <td class="odd" colspan="2"><small>{L_SPECIAL_EXPLAIN}</span></td>
	</tr>
	<tr> 
	  <td class="odd"><span class="gen">{L_USER_ACTIVE}</span></td>
	  <td class="even"> 
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_ALLOW_PM}</span></td>
	  <td class="even"> 
	...
	<tr> 
	  <td class="odd"><span class="gen">{L_ALLOW_AVATAR}</span></td>
	  <td class="even"> 
	...
	<tr>
		<td class="odd"><span class="gen">{L_SELECT_RANK}</span></td>
		<td class="even"><select name="user_rank">{RANK_SELECT_BOX}</select></td>
	</tr>
	<tr> 
	  <td class="odd"><span class="gen">{L_DELETE_USER}?</span></td>
	  <td class="even"> 
