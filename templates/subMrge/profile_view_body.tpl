...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	<td class="odd" height="6" valign="top" align="center">{AVATAR_IMG}<br /><span class="postdetails">{POSTER_RANK}</span></td>
	<td class="odd" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr> 
