...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="catHead" height="28"><h2><b>{L_THIS_POST_IP}</b></h2></td>
  </tr>
  <tr> 
	<td class="odd"> 
  ...
  <tr> 
	<td class="catHead" height="28"><h2><b>{L_OTHER_USERS}</b></h2></td>
  </tr>
  <!-- BEGIN userrow -->
  <tr> 
  ...
  <!-- END userrow -->
  <tr> 
	<td class="catHead" height="28"><h2><b>{L_OTHER_IPS}</b></h2></td>
  </tr>
  <!-- BEGIN iprow -->
  <tr> 
