...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="catSides" colspan="8" height="28"><h2>{L_PENDING_MEMBERS}</h2></td>
	</tr>
	...
	<tr> 
	  ...
	  <td class="{pending_members_row.ROW_CLASS}" align="center"><small> <input type="checkbox" name="pending_members[]" value="{pending_members_row.USER_ID}" checked="checked" /></span></td>
	</tr>
