...
<table class="forumline" width="100%" cellspacing="1" cellpadding="4" border="0">
	...
	<tr> 
		<td class="odd" width="20%"><span class="gen">{L_GROUP_NAME}:</span></td>
		<td class="even"><span class="gen"><b>{GROUP_NAME}</b></span></td>
	</tr>
	<tr> 
		<td class="odd" width="20%"><span class="gen">{L_GROUP_DESC}:</span></td>
		<td class="even"><span class="gen">{GROUP_DESC}</span></td>
	</tr>
	<tr> 
		<td class="odd" width="20%"><span class="gen">{L_GROUP_MEMBERSHIP}:</span></td>
		<td class="even"><span class="gen">{GROUP_DETAILS} &nbsp;&nbsp;
	...
	<tr> 
		<td class="odd" width="20%"><span class="gen">{L_GROUP_TYPE}:</span></td>
		<td class="even"><span class="gen"><span class="gen"><input type="radio" name="group_type" value="{S_GROUP_OPEN_TYPE}" {S_GROUP_OPEN_CHECKED} /> {L_GROUP_OPEN} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_CLOSED_TYPE}" {S_GROUP_CLOSED_CHECKED} />	{L_GROUP_CLOSED} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_HIDDEN_TYPE}" {S_GROUP_HIDDEN_CHECKED} />	{L_GROUP_HIDDEN} &nbsp;&nbsp; <input class="mainoption" type="submit" name="groupstatus" value="{L_UPDATE}" /></span></td>
	</tr>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="catSides" colspan="8" height="28"><h2>{L_GROUP_MODERATOR}</h2></td>
	</tr>
	<tr> 
	  <td class="odd" align="center"> {MOD_PM_IMG} </td>
	  <td class="odd" align="center"><span class="gen"><a href="{U_MOD_VIEWPROFILE}" class="gen">{MOD_USERNAME}</a></span></td>
	  <td class="odd" align="center" valign="middle"><span class="gen">{MOD_POSTS}</span></td>
	  <td class="odd" align="center" valign="middle"><span class="gen">{MOD_FROM}</span></td>
	  <td class="odd" align="center" valign="middle"><span class="gen">{MOD_EMAIL_IMG}</span></td>
	  <td class="odd" align="center">{MOD_WWW_IMG}</td>
	  <td class="odd" align="center"> &nbsp; </td>
	</tr>
	<tr> 
	  <td class="catSides" colspan="8" height="28"><h2>{L_GROUP_MEMBERS}</h2></td>
	</tr>
	<!-- BEGIN member_row -->
	<tr> 
	...
	<tr> 
	  <td class="odd" colspan="7" align="center"><span class="gen">{L_NO_MEMBERS}</span></td>
	</tr>
	<!-- END switch_no_members -->

	<!-- BEGIN switch_hidden_group -->
	<tr> 
	  <td class="odd" colspan="7" align="center"><span class="gen">{L_HIDDEN_MEMBERS}</span></td>
	</tr>
...
<table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr>
		...
		<td align="right" valign="top"><small>{S_TIMEZONE}</span><br /><span class="nav">{PAGINATION}</span></td>
	</tr>
</table>
