...
<!-- link rel="stylesheet" href="templates/TPnative/{T_HEAD_STYLESHEET}" type="text/css" -->
<style type="text/css">
<!--
...
td.rowpic {
		...
		background-image: url(templates/TPnative/images/{T_TH_CLASS3});
...
.phpbb th	{
	...
	background-image: url(templates/TPnative/images/{T_TH_CLASS2});
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(templates/TPnative/images/{T_TH_CLASS1});
...
@import url("templates/TPnative/formIE.css");
-->
</style>

<!-- Quick hack for the TPnative -->
<br><br><br>
<!-- End quick hack -->
