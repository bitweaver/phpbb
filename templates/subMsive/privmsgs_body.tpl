  ...
  <tr> 
	...
	<td align="right"> 
	  ...
	  <table width="175" cellspacing="1" cellpadding="2" border="0" class="bodyline">
		<tr> 
		  <td colspan="3" width="175" class="odd" nowrap="nowrap"><small>{BOX_SIZE_STATUS}</span></td>
		</tr>
		<tr> 
		  <td colspan="3" width="175" class="even">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="templates/subMsive/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
		<tr> 
		  <td width="33%" class="odd"><small>0%</span></td>
		  <td width="34%" align="center" class="odd"><small>50%</span></td>
		  <td width="33%" align="right" class="odd"><small>100%</span></td>
		</tr>
	  </table>
...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  ...
	  <td align="right" nowrap="nowrap"><small>{L_DISPLAY_MESSAGES}: 
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  <td class="odd" colspan="5" align="center" valign="middle"><span class="gen">{L_NO_MESSAGES}</span></td>
	</tr>
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr> 
	  ...
	  <td align="right" valign="top" nowrap="nowrap"><b><small><a href="javascript:select_switch(true);" class="small">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="small">{L_UNMARK_ALL}</a></span></b><br /><span class="nav">{PAGINATION}<br /></span><small>{S_TIMEZONE}</span></td>
	</tr>
  </table>
</form>
