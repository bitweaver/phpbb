...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
	<tr> 
		<td class="catHead" height="28" align="center"><h2>{faq_block.BLOCK_TITLE}</h2></td>
	</tr>
	<!-- BEGIN faq_row -->  
	<tr> 
	...
	<tr>
		<td class="spaceRow" height="1"><img src="templates/subMsive/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END faq_row -->
</table>
...
<table width="100%" cellspacing="2" border="0" align="center">
	<tr>
		<td align="right" valign="middle" nowrap="nowrap"><small>{S_TIMEZONE}</span><br /><br />{JUMPBOX}</td> 
	</tr>
</table>
