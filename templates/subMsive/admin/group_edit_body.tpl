...
<form action="{S_GROUP_ACTION}" method="post" name="post"><table border="0" cellpadding="3" cellspacing="1" class="forumline" align="center">
	...
	<tr>
	  <td class="odd" colspan="2"><small>{L_ITEMS_REQUIRED}</span></td>
	</tr>
	<tr> 
	  <td class="odd" width="38%"><span class="gen">{L_GROUP_NAME}:</span></td>
	  <td class="even" width="62%"> 
		<input class="post" type="text" name="group_name" size="35" maxlength="40" value="{GROUP_NAME}" />
	  </td>
	</tr>
	<tr> 
	  <td class="odd" width="38%"><span class="gen">{L_GROUP_DESCRIPTION}:</span></td>
	  <td class="even" width="62%"> 
		<textarea class="post" name="group_description" rows="5" cols="51">{GROUP_DESCRIPTION}</textarea>
	  </td>
	</tr>
	<tr> 
	  <td class="odd" width="38%"><span class="gen">{L_GROUP_MODERATOR}:</span></td>
	  <td class="even" width="62%"><input class="post" type="text" class="post" name="username" maxlength="50" size="20" value="{GROUP_MODERATOR}" /> &nbsp; <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></td>
	</tr>

	<tr> 
	  <td class="odd" width="38%"><span class="gen">{L_GROUP_STATUS}:</span></td>
	  <td class="even" width="62%"> 
	...
	<!-- BEGIN group_edit -->
	<tr> 
	  <td class="odd" width="38%"><span class="gen">{L_DELETE_MODERATOR}</span>
	  <br />
	  <small>{L_DELETE_MODERATOR_EXPLAIN}</span></td>
	  <td class="even" width="62%"> 
		<input type="checkbox" name="delete_old_moderator" value="1">
		{L_YES}</td>
	</tr>
	<tr> 
	  <td class="odd" width="38%"><span class="gen">{L_GROUP_DELETE}:</span></td>
	  <td class="even" width="62%"> 
