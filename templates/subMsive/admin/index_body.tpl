...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="odd" nowrap="nowrap">{L_NUMBER_POSTS}:</td>
	<td class="even"><b>{NUMBER_OF_POSTS}</b></td>
	<td class="odd" nowrap="nowrap">{L_POSTS_PER_DAY}:</td>
	<td class="even"><b>{POSTS_PER_DAY}</b></td>
  </tr>
  <tr> 
	<td class="odd" nowrap="nowrap">{L_NUMBER_TOPICS}:</td>
	<td class="even"><b>{NUMBER_OF_TOPICS}</b></td>
	<td class="odd" nowrap="nowrap">{L_TOPICS_PER_DAY}:</td>
	<td class="even"><b>{TOPICS_PER_DAY}</b></td>
  </tr>
  <tr> 
	<td class="odd" nowrap="nowrap">{L_NUMBER_USERS}:</td>
	<td class="even"><b>{NUMBER_OF_USERS}</b></td>
	<td class="odd" nowrap="nowrap">{L_USERS_PER_DAY}:</td>
	<td class="even"><b>{USERS_PER_DAY}</b></td>
  </tr>
  <tr> 
	<td class="odd" nowrap="nowrap">{L_BOARD_STARTED}:</td>
	<td class="even"><b>{START_DATE}</b></td>
	<td class="odd" nowrap="nowrap">{L_AVATAR_DIR_SIZE}:</td>
	<td class="even"><b>{AVATAR_DIR_SIZE}</b></td>
  </tr>
  <tr> 
	<td class="odd" nowrap="nowrap">{L_DB_SIZE}:</td>
	<td class="even"><b>{DB_SIZE}</b></td>
	<td class="odd" nowrap="nowrap">{L_GZIP_COMPRESSION}:</td>
	<td class="even"><b>{GZIP_COMPRESSION}</b></td>
  </tr>
</table>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="5" height="1" class="odd"><img src="../templates/subMsive/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
