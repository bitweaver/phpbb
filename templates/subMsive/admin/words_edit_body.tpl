...
<form method="post" action="{S_WORDS_ACTION}"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="odd">{L_WORD}</td>
		<td class="even"><input class="post" type="text" name="word" value="{WORD}" /></td>
	</tr>
	<tr>
		<td class="odd">{L_REPLACEMENT}</td>
		<td class="even"><input class="post" type="text" name="replacement" value="{REPLACEMENT}" /></td>
	</tr>
	<tr>
