			<tr>
				<td class="even" colspan="2"><br clear="all" /><form method="POST" action="{S_POLL_ACTION}"><table cellspacing="0" cellpadding="4" border="0" align="center">
					<tr>
		  ...
		  <td align="center"><small><b><a href="{U_VIEW_RESULTS}" class="small">{L_VIEW_RESULTS}</a></b></span></td>
					</tr>
